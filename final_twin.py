...
<p class="note">Development demonstration only. MRSIF records only evidence available from connected systems. Tool telemetry is not assumed where no instrumented source exists. This report does not represent OEM certification, live field telemetry, CFIHOS endorsement or OSDU endorsement.</p>
</body></html>"""
...
<div class="topbar">
  <div class="brand">{logo_html()}
    <div>
      <div class="brand-title">MRSIF-ROV <span style="color:#33d1ff;">Tooling & Intervention Mission Assurance</span></div>
      <div class="brand-sub">VODIDS · governed ROV tooling & intervention · CFIHOS asset context · OSDU operational context</div>
    </div>
  </div>
...
Tool output values are shown only when an actual instrumented source exists; otherwise MRSIF records <b>NOT INSTRUMENTED / NOT AVAILABLE</b>.
</div>
""", unsafe_allow_html=True)
...
st.markdown(f'<div style="margin-top:9px;border-top:1px solid #1e3141;padding-top:7px;color:#6f8798;font-size:8px;display:flex;justify-content:space-between"><span>VODIDS · MRSIF-ROV-ROV v1.0 Final Demonstration Release</span><span>Simulation only · {ts}</span></div>', unsafe_allow_html=True)
